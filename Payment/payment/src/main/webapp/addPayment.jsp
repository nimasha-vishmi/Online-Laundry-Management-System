            ...
            <div class="row gx-3">
                ...
                <div class="col-12">
                    <div class="d-flex flex-column">
                        ...
                        <input class="form-control mb-3" type="text" name="cardnumber" placeholder="1234 5678 4356 7899">
                    </div>
                </div>
                <div class="col-6">
                    <div class="d-flex flex-column">
                ...
                <div class="col-6">
                    <div class="d-flex flex-column">
                        ...
                        <input class="form-control mb-3 pt-2" type="password" name="cvc" placeholder="***" pattern="\d{3}" title="Please enter 3 digits">
